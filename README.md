...
自研控制板（STM32F103C8T6 + FPC 20P 转接），经 FPC 与功率级通信：3.3 V 供电、I2C1 读 INA226/TMP112、两路 PWM 作 DAC、使能与风扇控制、PGOOD 回读。
...
| --- | --- |
| ![FPC排线](picture/控制板-FPC排线.jpg) | ![接口与功能映射](picture/控制板-接口与功能映射.jpg) |

> 设计要点：4 个 VDD 脚各配独立 100 nF、VDDA 另配 10 nF + 1 µF、VBAT 单独 100 nF 并与 3.3 V 同轨；FPC 20 脚中 8 个 GND、4 个 3.3 V，每根信号线相邻 GND；I2C 走线串 22 Ω、I2C2 板载 4.7 k 上拉（I2C1 上拉在功率板侧）；PGOOD 经电阻分压后进 PB12。
...
过程记录与决策留档见 [`MEMO.md`](MEMO.md)、[`MEMO2.md`](MEMO2.md)、[`MEMO3.md`](MEMO3.md)。
