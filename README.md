...
| 整机连线测试 | 自研功率板（未连线） |
| --- | --- |
| ![整机连线测试](picture/测试-整机连线.jpg) | ![自研功率板](picture/底板-未连线-web.jpg) |

| 15 V → 6 V 跳变响应 | 满载 120 W 长时间工作 |
| --- | --- |
| ![15V到6V跳变响应](picture/15-6V跳变响应.jpg) | ![满载长时间工作](picture/长时间工作-电子负载1.jpg) |
...
自研约 1 千行代码支撑起 6 个 RTOS 任务、3 层传感器驱动、PID 闭环、OLED 显示与故障自恢复；最终固件 ROM 39.4 KB、RAM 14.4 KB。
